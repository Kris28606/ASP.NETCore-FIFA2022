        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Team3Id = table.Column<int>(type: "int", nullable: false),
                    Team4Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Groups", x => x.GroupId);
                    table.ForeignKey(
                        name: "FK_Groups_Teams_Team1Id",
                        column: x => x.Team1Id,
                        principalTable: "Teams",
                        principalColumn: "TeamId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Groups_Teams_Team2Id",
                        column: x => x.Team2Id,
                        principalTable: "Teams",
                        principalColumn: "TeamId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Groups_Teams_Team3Id",
                        column: x => x.Team3Id,
                        principalTable: "Teams",
                        principalColumn: "TeamId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Groups_Teams_Team4Id",
                        column: x => x.Team4Id,
                        principalTable: "Teams",
                        principalColumn: "TeamId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Groups_Team1Id",
                table: "Groups",
                column: "Team1Id");

            migrationBuilder.CreateIndex(
                name: "IX_Groups_Team2Id",
                table: "Groups",
                column: "Team2Id");

            migrationBuilder.CreateIndex(
                name: "IX_Groups_Team3Id",
                table: "Groups",
                column: "Team3Id");

            migrationBuilder.CreateIndex(
                name: "IX_Groups_Team4Id",
                table: "Groups",
                column: "Team4Id");
